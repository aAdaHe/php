    ...
    <style>
        ...
        *{
        ...
        .modal {
            ...
            position: fixed; /* Stay in place  固定定位 */
            z-index: 1; /* Sit on top  疊層最高 */
            right: 50;
            top: 50;
            width: 20%; /* Full width  寬度 */
            height: 20%; /* Full height   高度 */
            overflow: auto; /* Enable scroll if needed  需要時顯示滾動條 */
            background-color: rgba(255,255,255,0.9); /* Black w/ opacity   白色半透明背景 */
            padding-top: 50px;
        }  /*登入畫面css*/
        /*佈告欄*/
        .bulletin{
